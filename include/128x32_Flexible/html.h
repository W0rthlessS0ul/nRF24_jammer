...
static const char *const html_ota = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_pls_reboot = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_jam = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_settings = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_wifi_settings = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_wifi_select = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div class="container">
        ...
        <div id="deauthOptions" class="options hidden">
            <button class="btn" onclick="location.href='/wifi_deauth_all'">
                <div class="method-info">
                    <div class="method-name">Deauth All Channels</div>
                    <div class="method-desc">Disconnect all WiFi clients from every AP</div>
                </div>
            </button>
            <button class="btn" onclick="location.href='/wifi_deauth_channel'">
                <div class="method-info">
                    <div class="method-name">Select Channel To Deauth</div>
                    <div class="method-desc">Target specific WiFi channel (1-14) for deauth</div>
                </div>
            </button>
            <button class="btn" onclick="location.href='/wifi_deauth_scan'">
                <div class="method-info">
...
static const char *const html_ble_select = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_wifi_channel = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    ...
    <div class="container">
        ...
        <div class="buttons-group">
            <button class="btn" onclick="validateAndRedirect()">Start attack</button>
...
static const char *const html_misc_jammer = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
static const char *const html_webserial = R"rawliteral(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
static const String html_buttons_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
...
static const String html_logo_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
            <h1>Logo Settings</h1>
        </div>
...
static const String html_misc_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
...
static const String html_display_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
...
static const String html_bluetooth_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
...
static const String html_drone_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
...
static const String html_separate_or_together PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
...
static const String html_nrf_pa_settings PROGMEM = String(R"rawliteral(
    <div class="container">
        <div class="header">
