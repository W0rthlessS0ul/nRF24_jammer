    ...
    if (FirstWord == "help") {
      ...
      if (SecondWord == "-1" || ThirdWord == "-1"){
        ...
        SettingInfo settings[] = {
          ...
          {"Logo", logo, "0 - Show logo on startup, 1 - Hide logo on startup"},
          {"AccessPoint", access_point, "0 - Enable access point, 1 - Disable access point"},
          {"Buttons", buttons, "0 - Single-button control (25 pin), 1 - Two-button control (25, 26 pin), 2 - Three-button control (25, 26, 27 pin)"},
        ...
        Serial.println("Written successfully\n");
      } else if (SecondWord == "logo" && ThirdWord.toInt() >= 0 && ThirdWord.toInt() <= 1){
        storeEEPROMAndSet(7, ThirdWord.toInt(), logo);
        Serial.println("Written successfully\n");
      } else if (SecondWord == "accesspoint" && ThirdWord.toInt() >= 0 && ThirdWord.toInt() <= 1){
