...
void wifi_channel(int channel1)
{
  vTaskPrioritySet(NULL, 3);
  while ( !stopJam )
  {
...
void jamHandler(void (*action)(), String htmlResponse, const unsigned char *bitmap, bool mode, bool isMisc, bool scan, int ch1, int ch2)
{
  global_ch1              = ch1;
  global_ch2              = ch2;
  stopJam                 = false;
